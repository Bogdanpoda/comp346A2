...
public class Client extends Thread {
    ...
    private static boolean running1=false,running2=false;

    private static String clientThreadRunningStatus1;	 /* Running status of thread 1 - idle, running, terminated */
    private static String clientThreadRunningStatus2;	 /* Running status of thread 2 - idle, running, terminated */
    ...
    public void run()
    {
        ...
        if(clientOperation.equals("sending"))
            clientThreadRunningStatus1="running";

        if(clientOperation.equals("receiving"))
            clientThreadRunningStatus2="running";
        ...
        if (clientOperation.equals("receiving")) {
            ...
            try {
                FileWriter myWriter = new FileWriter("comp346-pa2-output-semaphores.txt");
...
//                }
               /* if (Network.getOutBufferStatus().equals("empty")) {
                ...
                Network.receive(transaction[l]);
                    ...
                    myWriter.write(transaction[l].toString());
                ...
                //receiveTransactions(transaction[l]);
            }
        ...
        if(clientOperation.equals("sending"))
            clientThreadRunningStatus1="terminated";

        if(clientOperation.equals("receiving"))
            clientThreadRunningStatus2="terminated";

        if(clientThreadRunningStatus1.equals("terminated")&&clientThreadRunningStatus2.equals("terminated")){
